  ...
  const features = [
    {
      ...
      description:
        "Analyze your resume compatibility against industry standard filters with detailed section checks.",
    },
    {
      icon: (
      ...
      description:
        "Match your technical skills against target jobs and discover exactly what technologies are missing.",
    },
    {
      icon: (
        <Compass className="text-indigo-600 dark:text-indigo-400" size={24} />
      ),
      title: "Interactive Roadmaps",
      description:
        "Follow customized learning steps with recommended resources to bridge your professional gaps.",
    },
    {
      icon: (
      ...
      description:
        "Get curated suggestions for portfolio projects, certifications, and technical interview questions.",
    },
  ];
  ...
  return (
    <div className="flex-1 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors duration-300">
      ...
      <section className="relative overflow-hidden pt-20 pb-16 lg:pt-32 lg:pb-24 grid-bg">
        ...
        <div
          className="absolute top-1/3 right-1/4 -z-10 h-72 w-72 rounded-full bg-purple-400/10 blur-3xl dark:bg-purple-600/5 animate-pulse-slow"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-6 text-lg sm:text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed">
            Upload your resume, analyze your ATS score, map your skill gaps, and
            follow personalized learning roadmaps to unlock your dream role.
          </p>
          ...
          <div className="mt-16 max-w-4xl mx-auto rounded-2xl glass-card p-4 sm:p-6 shadow-2xl relative border border-slate-200/40 dark:border-slate-800/40 hover:scale-[1.01] transition-transform duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 rounded-xl bg-indigo-50/50 dark:bg-indigo-950/20 border border-indigo-100/30 dark:border-indigo-900/10">
                ...
                <div className="text-4xl font-extrabold mt-2 text-indigo-700 dark:text-indigo-300">
                  82%
                </div>
              ...
              <div className="p-4 rounded-xl bg-purple-50/50 dark:bg-purple-950/20 border border-purple-100/30 dark:border-purple-900/10">
                ...
                <div className="text-xl font-bold mt-3 text-purple-700 dark:text-purple-300">
                  Full Stack Dev
                </div>
                <p className="text-xs mt-1 text-slate-500">
              ...
              <div className="p-4 rounded-xl bg-emerald-50/50 dark:bg-emerald-950/20 border border-emerald-100/30 dark:border-emerald-900/10">
                ...
                <div className="text-sm font-medium mt-2 text-slate-700 dark:text-slate-300">
                  <span className="bg-emerald-200 dark:bg-emerald-900/40 text-emerald-800 dark:text-emerald-300 px-1.5 py-0.5 rounded text-[10px] mr-1">
                    React
                  </span>
                  <span className="bg-emerald-200 dark:bg-emerald-900/40 text-emerald-800 dark:text-emerald-300 px-1.5 py-0.5 rounded text-[10px] mr-1">
                    Node
                  </span>
                  <span className="bg-rose-100 dark:bg-rose-950/40 text-rose-800 dark:text-rose-400 px-1.5 py-0.5 rounded text-[10px] line-through">
                    Docker
                  </span>
                </div>
                <p className="text-xs mt-2.5 text-rose-500">
                  1 Missing Core Skill
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-4 text-slate-600 dark:text-slate-400 leading-relaxed">
              We leverage modern Natural Language Processing (NLP) models to
              parse entities, calculate cosine context similarity, and construct
              skill-gap pathways.
            </p>
          </div>
          ...
          <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feat, index) => (
              <div
                key={index}
                className="p-6 rounded-2xl border border-slate-200/50 dark:border-slate-800/40 bg-slate-50 dark:bg-slate-950/40 hover:-translate-y-1 transition-transform duration-250 hover:shadow-lg dark:hover:shadow-indigo-950/10"
              >
                ...
                <h3 className="font-display font-bold mt-5 text-lg">
                  {feat.title}
                </h3>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl bg-indigo-600/5 dark:bg-indigo-950/20 border border-indigo-200/20 dark:border-indigo-900/10 p-8 sm:p-12 flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="max-w-xl">
              ...
              <p className="mt-2 text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                All uploaded resumes are sanitized and stored securely. We use
                JSON Web Tokens to protect access routes, ensuring your
                credentials and career data remain safe.
              </p>
            </div>
